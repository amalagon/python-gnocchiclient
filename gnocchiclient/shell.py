...
"""
Command-line interface to the OpenStack Gnocchi API.
"""
...
from gnocchiclient import client as gnoclient
from gnocchiclient.common import utils
from gnocchiclient import exc
from gnocchiclient.openstack.common import cliutils
from gnocchiclient.openstack.common import strutils


class GnocchiShell(object):

    def get_base_parser(self):
        parser = argparse.ArgumentParser(
            prog='gnocchi',
            description=__doc__.strip(),
            epilog='See "gnocchi help COMMAND" '
        ...
        parser.add_argument('--version',
                            action='version',
                            version=gnocchiclient.__version__)

        parser.add_argument('-d', '--debug',
                            default=bool(cliutils.env('GNOCCHICLIENT_DEBUG')
                                         ),
                            action='store_true',
                            help='Defaults to env[GNOCCHICLIENT_DEBUG].')
        ...
        parser.add_argument('-k', '--insecure',
                            default=False,
                            action='store_true',
                            help="Explicitly allow gnocchiclient to "
        ...
        parser.add_argument('--gnocchi-url',
                            default=cliutils.env('GNOCCHI_URL'),
                            help='Defaults to env[GNOCCHI_URL].')

        parser.add_argument('--gnocchi_url',
                            help=argparse.SUPPRESS)

        parser.add_argument('--gnocchi-api-version',
                            default=cliutils.env(
                                'GNOCCHI_API_VERSION', default='2'),
                            help='Defaults to env[GNOCCHI_API_VERSION] '
                            'or 2.')
    ...
    def parse_args(self, argv):
        ...
        api_version = options.gnocchi_api_version
    ...
    def do_bash_completion(self, args):
        ...
        The gnocchi.bash_completion script doesn't have to hard code them.
        """
        commands = set()
        options = set()
